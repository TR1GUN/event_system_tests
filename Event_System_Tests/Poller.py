...
from Template.CheckUP_Poller import CheckUpGET, CheckUpPUT, CheckUpPOST, CheckUpDELETE


class Poller(EventDataAPI):
    """

    Этот класс Работает с таблицей MeterTemplates

    """
    _template_post ={"method":"post", "table":"Poller", "settings":[{"id":1, "metersName":"vasya", "archTypesName":"vasya"}]}
    _template_put = {"method":"put", "table":"Poller", "settings":[{"id":1, "metersName":"vasya", "archTypesName":"vasya"}]}
    _template_get = {"method":"get", "table":"Poller"}
    _template_delete = {"method":"delete", "table":"Poller"}
