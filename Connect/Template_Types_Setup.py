...
from Connect import Byte_coding_decoding
...
class SetupVirtualBox:
    ...
    def __init__(self, JSON: str, API: str):
        ...
        from Connect.Virtual_Box import vm
    ...
    def __connect_to_virtual_machine(self):
        ...
        # Ищем нашу машину
        from Connect.Config_Parser_Connect import user_login, user_password, domain
...
class SetupSSH:
    ...
    def _start_ssh(self):
        ...
        from Config_Parser_Connect import user_login, user_password, address_ssh
        # Делаем подкючение к нужному серверу

        # Конектимся
        client.connect(hostname=str(address_ssh), username=str(user_login), password=str(user_password),
